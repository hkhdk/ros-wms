...
public class RoomController {
    ...
    public Result save(@RequestBody Room room) {
        return roomService.save(room) ? Result.suc() : Result.fail();
    }
...
//    }
    ...
    @GetMapping("/del")
    public Result del(@RequestParam String sequence, @RequestParam String table) {
        System.out.println(table);
        return roomService.removeByTId(sequence, table) ? Result.suc() : Result.fail();
    }
